...
export default TypeLogos = {
  ...
  "LIGHTNING": require('../../resources/images/types/Lightning-attack.png'),
  "PSYCHIC": require('../../resources/images/types/Psychic-attack.png'),
  "FIGHTING": require('../../resources/images/types/Fighting-attack.png'),
  "COLORLESS": require('../../resources/images/types/Colorless-attack.png'),
